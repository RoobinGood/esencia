	...
	Router.processController = function(controller, stage, callback) {
		...
		if (parentName) {
			...
			this.processController(parent, parentStage, function() {
				...
				controller.process(stage, function() {
					/*if (controller.view.parent) {
						parent.view.removeView(controller.view, controller.container);
					}
					parent.view.insertView(controller.view, controller.container);*/
